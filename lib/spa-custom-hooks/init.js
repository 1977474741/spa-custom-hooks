...
const userAgentKeys = {
    ...
    miniprogram: {
        ...
        initHookComponentAlipayCreated: 'created',
        ...
        ...(BASE.name === 'miniprogram'
            ? {
                  ...
                  lifetimes: {
                      ...
                      [BASE.initHookComponentAlipayCreated](optionProperties, options) {
                          componentHookTriggered.call(
                              this,
                              optionProperties,
                              options,
                              BASE.initHookComponentAlipayCreated
                          );
                      },
                  },
                  pageLifetimes: {
